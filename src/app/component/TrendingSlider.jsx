...
async function getData() {
  const query = `*[_type == 'product'][7...15] | order( _updatedAt desc){
  ...
  return (
    ...
    >
      <CarouselContent>
          ...
          {data.map((item) => (
            <CarouselItem key={item._id} className="sm:basis-1/2 lg:basis-1/2 basis-1/4 w-full ">
            <div className="p-1">
              <Card>
    ...
    <Image src={item.image}  width={300} height={300} alt="trending" className=' w-full block' />
    {item.class ? (
