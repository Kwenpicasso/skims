...
const NavigationMenu = ({scrolling}) => {
  return (
    <div className={`flex gap-6 items-center justify-center font-bold text-[11px] cursor-pointer ${scrolling ? 'text-darkbrown' : 'text-white'}`}>
...
<div className="dropdown dropdown-hover">
  ...
  <h1>lingerie</h1>
    ...
    <div className='oee'>
      <Image src='/x.webp' width={150} height={150} alt='shirt' className=''/>
    ...
    <div className='oee'>
      <Image src='/xx.webp' width={150} height={150} alt='shitr' className=''/>
       <h1>the t-shirt shop</h1>
...
<div className="dropdown dropdown-hover">
  ...
  <h1>fabric guide</h1>
    ...
    <div className='oee'>
      <Image src='/aa.webp' width={150} height={150} alt='save' className=''/>
    ...
    <div className='oee'>
      <Image src='/aaa.webp' width={150} height={150} alt='save' className=''/>
...
<div className="dropdown dropdown-hover">
  ...
  <div tabIndex={0} className="over w-[1050px] left-[-700px]">
    ...
    <div className='oee'>
      <Image src='/yyyy.webp' width={150} alt='save' height={150} className=''/>
      <h1 className=''>cotton</h1>
      <p className='small'>the selfie-worthy sets you've seen all over your feed</p>
    </div>
    <div className='oee'>
      <Image src='/yyyyy.webp' width={150} alt='save' height={150} className=''/>
